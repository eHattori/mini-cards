...
class ActiveRecord::Migration::ReversibleBlockHelper < Anonymous_Struct_19
  def down; end
  def up; end
end
...
class ActiveRecord::MigrationProxy < Anonymous_Struct_20
...
class ActiveRecord::ConnectionAdapters::PostgreSQL::OID::Json < ActiveRecord::Type::Internal::AbstractJson
end
class ActiveRecord::ConnectionAdapters::PostgreSQL::OID::Jsonb < ActiveRecord::ConnectionAdapters::PostgreSQL::OID::Json
  def changed_in_place?(raw_old_value, new_value); end
  def type; end
end
...
class ActiveRecord::ConnectionAdapters::PostgreSQL::OID::Rails51Point < ActiveModel::Type::Value
...
module ActiveRecord::ConnectionAdapters::PostgreSQL::SchemaStatements
  ...
  def table_options(table_name); end
  def tables(name = nil); end
  def type_to_sql(type, limit = nil, precision = nil, scale = nil, array = nil); end
  def view_exists?(view_name); end
  def views; end
end
class ActiveRecord::ConnectionAdapters::PostgreSQLTypeMetadata < Anonymous_Delegator_29
  def ==(other); end
  def array; end
  def attributes_for_hash; end
  def eql?(other); end
...
class ActiveRecord::ConnectionAdapters::PostgreSQLAdapter < ActiveRecord::ConnectionAdapters::AbstractAdapter
  ...
  def load_additional_types(type_map, oids = nil); end
  def lookup_cast_type(sql_type); end
  def max_identifier_length; end
  def native_database_types; end
...
class ActiveRecord::SchemaMigration < ActiveRecord::Base
  ...
  include Anonymous_ActiveRecord_AttributeMethods_GeneratedAttributeMethods_2
end
module Anonymous_ActiveRecord_AttributeMethods_GeneratedAttributeMethods_2
  def self.lock; end
  def self.locked?; end
  def self.synchronize(&block); end
  def self.try_lock; end
